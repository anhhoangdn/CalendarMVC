        ...
        for (Component c : dayPanel.getComponents()) {
            ...
            b.setUI(new BasicButtonUI() {
                @Override public void paint(Graphics g, JComponent c) {
                    ...
                    } else if (m.isPressed()) { g2.setColor(new Color(180,210,255)); g2.fillOval(x,y,sz,sz);
                    } else if (m.isRollover()) { g2.setColor(new Color(230,240,255)); g2.fillOval(x,y,sz,sz); }
                    ...
                    g2.setColor(m.isSelected()?Color.WHITE : Color.DARK_GRAY);
